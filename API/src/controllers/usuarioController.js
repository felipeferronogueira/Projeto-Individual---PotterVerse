            ...
            .then(
                function (resultadoAutenticar) {
                    ...
                    if (resultadoAutenticar.length == 1) {
                        ...
                        aquarioModel.buscarAquariosPorEmpresa(resultadoAutenticar[0].casaHogwartsId)
...
function cadastrar(req, res) {
    ...
    var email = req.body.emailServer;
    var senha = req.body.senhaServer;
    var casaHogwartsId = req.body.casaServer;
    ...
    } else if (casaHogwartsId == undefined) {
        res.status(400).send("Sua casa está undefined!");
    } else {

        // Passe os valores como parâmetro e vá para o arquivo usuarioModel.js
        usuarioModel.cadastrar(nome, cpf, email, senha, casaHogwartsId)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
